...
Si encontrás un problema de seguridad, abrí un [GitHub Security Advisory](https://github.com/ghcetraro/terraform_aws_eks_efs/security/advisories/new) o contactá al mantenedor del repo. No abras issues públicos con detalles explotables.
